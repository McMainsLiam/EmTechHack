...
const CustomHeroWide = ({ children, offset }) => (
  <>
    <div className="filterMeUp">
      <Divider speed={0.2} offset={offset}>
        <UpDown>
          <SVG icon="triangle" hiddenMobile width={48} stroke={colors.orange} left="-5%" top="5%" />
        ...
        <SVG icon="hexa" width={16} stroke={colors['grey-darker']} left="8%" top="50%" />
...
export default CustomHeroWide

CustomHeroWide.propTypes = {
